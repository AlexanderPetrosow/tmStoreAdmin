...
@section('content')
    ...
    <div class="input-group-flex d-flex">
        <div class="input-label-col">
            ...
            <button class="modal-button" data-bs-toggle="modal" data-bs-target="#categoryModal">Выберите категорию</button>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      <button type="button" class="btn btn-primary modal-select-button" data-bs-dismiss="modal">Выбрать</button>
                    </div>
                  </div>
                </div>
              </div>
